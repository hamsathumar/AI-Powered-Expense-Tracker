...
export function buildInterpretationSystemInstruction(ctx: InterpretPromptContext): string {
  return [
    ...
    'Specialized (recurring) = { operationKind:"recurring", operation:"expense"|..., baseAmount: Amount, recurrenceExpression?: string, intervalHint?: "daily"|"weekly"|"monthly"|"yearly"|"custom", anchorDateExpression?: ..., evidenceStrength: "clear"|"strong"|"ambiguous"|"one_time", recurringEvidence: Evidence[], account?, category?, ... }',
